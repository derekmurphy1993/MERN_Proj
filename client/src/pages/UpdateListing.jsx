...
export default function UpdateListing() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // + to make sure always converted to NUMBER and not string of number
            if (+formData.regularPrice < +formData.discountPrice) return setError('Discount cannot be higher than regular price.');
  ...
  return (
    ...
    <div className="flex flex-col gap-4 flex-1">
        ...
        <div className='flex flex-wrap gap-6'>
            ...
            <div className='flex items-center gap-2'>
                <input className='p-3 border border-gray-300 rounded-lg' type='number' id='regularPrice' min='50' max='1000000' 
            ...
            { formData.offer && (
                <div className='flex items-center gap-2'>
                <input className='p-3 border border-gray-300 rounded-lg' type='number' id='discountPrice' min='0' max='1000000' 
    ...
    <div className='flex flex-col flex-1 gap-4'>
        ...
        <p className='text-red-700 text-sm text-center'>{imageUploadError && imageUploadError}</p>
        { formData.imageUrls.length > 0 && formData.imageUrls.map((url, index) => (
            ...
            <button type="button" onClick={()=>{handleRemoveImage(index)}} className='p-3 text-red-700 rounded-lg uppercase
                hover:opacity-90 disabled:opacity-70'>Delete</button>
            </div>
        ))
        }
