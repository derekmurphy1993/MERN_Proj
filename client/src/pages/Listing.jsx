...
return (
    <main>
        ...
        {listing && !loading && !error && 
            ...
            {copied && setTimeout(() => {
                setCopied(false)
            }, 3000) && <p className='fixed top-[23%] right-[5%] z-10
            rounded-md bg-slate-50 p-3'> Link Copied </p>}
            <div className='flex flex-col max-w-4xl mx-auto p-3 mt-7 gap-4'>
                ...
                <ul className=' text-green-900 font-semibold text-sm flex flex-wrap items-center gap-4 sm:gap-6'>
                    ...
                    <li className='flex items-center gap-1 whitespace-nowrap'><FaBath className="text-lg" /> 
                        {listing.bathrooms > 1 ? `${listing.bathrooms} baths` : `${listing.bedrooms} bath`}</li>
